...
@usuario_empresas_bp.route("/estado", methods=["GET"])
def get_estado():
    try:
...
@usuario_empresas_bp.route("/estado", methods=["PUT"])
def actualizar_estado():
    try:
        ...
        res = UsuarioEmpresasController.actualizar_estado(usuario_id, empresa_id, estado, rol_id)
